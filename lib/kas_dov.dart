...
class KassaDovriyyesi extends StatefulWidget {
  @override
  _KassaDovriyyesiState createState() => _KassaDovriyyesiState();
}

class _KassaDovriyyesiState extends State<KassaDovriyyesi> {
  List<dynamic> data = [];
  ...
  Future<void> fetchData() async {
    final String baseUrl = 'http://192.168.0.103:3000/api/kas_dov';
